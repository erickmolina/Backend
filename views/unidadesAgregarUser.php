		...
		<div class="cssmenu">
		  <nav id="nav" role="navigation">
			...
			<ul class="clearfix">
				...
				<li><a href="start.html"><span>Descarga</span></a></li>
				<li><a href="work.html"><span>Información</span></a></li>
      	 ...
      	 <div class="section group">
				<div class="cont span_2_of_blog">
				  <div class="login-title">
           		<h4 class="title">Agregar Unidades</h4>
					...
					<form action="" method="post" name="login" id="login-form">
					  <fieldset class="input">
						...
						<p id="nombre">
					      ...
					      <input id="modlgn_identificador" type="text" name="indentificador" class="inputbox" size="18" autocomplete="off">
					    </p>
						<p id="nombre">
					      <label for="modlgn_username">Latitud</label>
					      <input id="modlgn_identificador" type="text" name="lat" class="inputbox" size="18" autocomplete="off">
					    </p>
						<p id="nombre">
					      <label for="modlgn_username">Longitud</label>
					      <input id="modlgn_identificador" type="text" name="lon" class="inputbox" size="18" autocomplete="off">
					    </p>
						<p id="nombre">
					      <label for="modlgn_username">Estado</label>
					      <input id="modlgn_identificador" type="text" name="estado" class="inputbox" size="18" autocomplete="off">
					    </p>
