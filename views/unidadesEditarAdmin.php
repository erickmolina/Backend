      	 ...
      	 <div class="section group">
				<div class="cont span_2_of_blog">
				  <div class="login-title">
           		<h4 class="title">Editar Unidades</h4>
					  ...
					  <fieldset class="input">
					    <p id="login-form-username">
					      ...
					      <select id="empresa" name="empresa" onchange="change_country(this.value)" class="frm-field required">
							...
							<label for="modlgn_username">Identificador Unidad</label>
							<select id="unidad" name="unidad" onchange="change_country(this.value)" class="frm-field required">
								<option value="null">Seleccione la parada</option>         
								<option value="AX">Ejemplo borrar</option>
								<option value="AF">Ejemplo2</option>
							</select>
					    </p>
