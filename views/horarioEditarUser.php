      	 ...
      	 <div class="section group">
				<div class="cont span_2_of_blog">
				  <div class="login-title">
           		<h4 class="title">Editar Horario</h4>
					  ...
					  <fieldset class="input">
					    <p id="login-form-username">
						  ...
						  <label for="modlgn_username">Ruta</label>
							...
							<label for="modlgn_username">Horario</label>
							<select id="ruta" name="horario" onchange="change_country(this.value)" class="frm-field required">
								<option value="null">Seleccione la Horario</option>         
								<option value="AX">Ejemplo borrar</option>
								<option value="AF">Ejemplo2</option>
							</select>
